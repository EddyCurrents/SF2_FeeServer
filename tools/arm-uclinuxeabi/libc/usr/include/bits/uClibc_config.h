...
#define __KERNEL_HEADERS__ "/scratch/julian/2010q1-release-uclinux-lite/install/arm-uclinuxeabi/libc/./usr/include"
...
#define __CROSS_COMPILER_PREFIX__ "/scratch/julian/2010q1-release-uclinux-lite/install/bin/arm-uclinuxeabi-"
